...
def extract_words_from_phrases(
    ...
    saved_sentences = query.filter(SavedPhrase.phrase_type == "SENTENCE").all()
    ...
    existing_words = {
        ...
        .filter(SavedPhrase.user_id == current_user.id, SavedPhrase.phrase_type == "WORD")
        .all()
    }
    ...
    for item in saved_sentences:
        ...
        candidates = [
            ...
            and w.lower() not in existing_words
